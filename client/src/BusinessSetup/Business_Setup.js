...
class Business_Setup extends Component {
    ...
    showStep(step) {
        switch (step) {
            case 1:
                return <Bus_Identification_1 userData={this.state.userData} setUserData={this.setUserData.bind(this)} setStep={this.setStep.bind(this)} />
            case 2:
    ...
    render(){
        ...
        return (
            ...
            <div className="App">
                ...
                <Stepper style={{ width: '65%'}} activeStep={ this.state.currentStep-1 } orientation="horizontal">
                  <Step>
                      <StepLabel></StepLabel>
                  </Step>
                  <Step>
