...
export default function Point_Of_Contact(props) {
    ...
    return (
        <div>
                ...
                <div style={{ float: 'right', width: '70%', marginLeft: '8%', border: '1px solid rgba(0, 0, 0, 0.07)' }}>
                    <div id="pt_cntct_div_1" style={{display: 'flex'}}>
                        <div style={{ width: '30%',  marginLeft: '6%'}}>
                            ...
                            <TextField style={{ height: '8%' }} value={props.userData['bus_owner_f_name']} onChange={(e) => props.setUserData({ ...props.userData, "bus_owner_f_name": e.target.value })}  placeholder="First Name " margin="normal" variant="outlined" color="secondary" />
                        </div>
                        <div style={{ width: '30%', marginRight: '2%', marginLeft: '2%' }}>
                            ...
                            <TextField style={{ height: '8%' }} value={props.userData['bus_owner_m_name']} onChange={(e) => props.setUserData({ ...props.userData, "bus_owner_m_name": e.target.value })}    placeholder="Middle Name " margin="normal" variant="outlined" color="secondary" />
                        </div>
                        <div style={{ width: '30%', marginRight: '5%' }}>
                            ...
                            <TextField style={{ height: '8%' }} value={props.userData['bus_owner_l_name']} onChange={(e) => props.setUserData({ ...props.userData, "bus_owner_l_name": e.target.value })}    placeholder="Last Name" margin="normal" variant="outlined" color="secondary" />
                        </div>
                    </div>
                    <div style={{marginRight: '5%' }}>
                        ...
                        <TextField id="txt_bus_pos" value={props.userData['bus_owner_position']} onChange={(e) => props.setUserData({ ...props.userData, "bus_owner_position": e.target.value })}   style={{ height: '8%', marginLeft: '6%', width: '94%' }} placeholder="CEO, Business owner, etc " margin="normal" variant="outlined" color="secondary" />
                    </div>
                    ...
                    <div id="pt_cntct_div_2" style={{ width: '95%', display: 'flex', marginLeft: '4.5%' }} >
                        <div style={{ width: '30%' }}>
                            ...
                            <Select id="drpdwn_coc" value={props.userData['bus_owner_coc']} onChange={(e) => props.setUserData({ ...props.userData, "bus_owner_coc": e.target.value })} place holder="Country" variant="outlined" color="secondary" style={{
                        ...
                        <div style={{ width: '31%' }}>
                            ...
                            <Select id="drpdwn_cob" value={props.userData['bus_owner_cob']} onChange={(e) => props.setUserData({ ...props.userData, "bus_owner_cob": e.target.value })}   style={{
                                marginLeft: '13%'
                        ...
                        <div style={{ width: '30%' }}>
                            ...
                            <TextField placeholder="mm/dd/yyyy" value={props.userData['bus_owner_dob']} onChange={(e) => props.setUserData({ ...props.userData, "bus_owner_dob": e.target.value })}  style={{ marginTop: '3%', marginLeft: '17%' }} variant="outlined" color="secondary" />
                        </div>
                    </div>
            ...
            <footer id="pt_cntct_div" style={{
                ...
                <Button id="btn_back" style={{ width: '160px', height: '32px', borderRadius: '15px', marginLeft: '3%', fontSize: '14px', fontFamily: 'DM Sans', lineHeight: '16px', fontWeight: 500 }} variant="contained" onClick={() => props.setStep(2)} color="primary">Back</Button>
                ...
                <Button id="btn_next" style={{ width: '160px', height: '32px', borderRadius: '15px', marginLeft: '20%', fontSize: '14px', fontFamily: 'DM Sans', lineHeight: '16px', fontWeight: 500 }} variant="contained" onClick={() => props.setStep(4)} color="primary">Next</Button>
