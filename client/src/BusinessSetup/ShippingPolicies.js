    ...
    const handleNext = (exit = false) => {
        ...
        if (returnPolicy) {
            uploadPDF(returnPolicy, (key) => {
                ...
                createOrUpdateBusiness({ "return_policy": key, "business_id": business_id })
        ...
        if (additionalPolicies) {
            uploadPDF(additionalPolicies, (key) => {
                ...
                createOrUpdateBusiness({ "additional_policies": key, "business_id": business_id })
            });
    ...
    return (
        <div style={{ width: '60%' }}>
            ...
            <footer id="pt_cntct_2_div" style={{
                ...
                <Button onClick={() => handleNext(true)} id="btn_save_submit" style={{ marginLeft: '3.5%', width: '220px', height: '32px', borderRadius: '15px', marginLeft: '3%', fontSize: '14px', fontFamily: 'DM Sans', lineHeight: '16px', fontWeight: 500 }} variant="contained" color="primary">Save & continue later</Button>
