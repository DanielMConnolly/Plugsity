    ...
    render() {
        ...
        <div>
            ...
            <div className="center">
                ...
                <div className="stars">
                    <input type="radio" id="five" name="rate" value="5" onChange={this.handleInputChange}/>
                    <label for="five"></label>
                    <input type="radio" id="four" name="rate" value="4" onChange={this.handleInputChange}/>
                    <label for="four"></label>
                    <input type="radio" id="three" name="rate" value="3" onChange={this.handleInputChange}/>
                    <label for="three"></label>
                    <input type="radio" id="two" name="rate" value="2" onChange={this.handleInputChange}/>
                    <label for="two"></label>
                    <input type="radio" id="one" name="rate" value="1" onChange={this.handleInputChange}/>
                    <label for="one"></label>
