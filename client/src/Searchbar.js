...
class Searchbar extends Component {
    ...
    createCityList(){
        cities= ["New York", "Seattle", "Los Angeles", "Austin", "Chicago", "Philadelphia", "Dallas"]
        city_list = []
        cities.forEach((city, index)=> city_list+={"id": index, "title": city, "selected": false});
